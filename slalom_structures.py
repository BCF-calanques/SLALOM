...
class MeasureType:
    ...
    def __init__(self, displayed_name, var_name, description, type_):
...
class MeasureFullType(MeasureType):
    ...
    def __init__(self, displayed_name, var_name, description, type_, mode_Bs = False, mode_Bg = False, mode_En = False, mode_Eq = False, mode_Bn = False):
        MeasureType.__init__(self, displayed_name, var_name, description, type_)
...
class PerformanceMeasures:
    ...
    name_map_full = (
        MeasureFullType('Nseq', 'seq_n', 'Number of sequences', 'int', mode_Bs = True, mode_Bg = True, mode_En = True, mode_Eq = True, mode_Bn = True),
        MeasureFullType('Rel.', 'p1', 'Share of relevant symbols (=TP+FN)', 'float', mode_Bs = True, mode_En = True, mode_Bn = True),
        MeasureFullType('Sel.', 'p2', 'Share of selected/predicted symbols (=TP+FP)', 'float', mode_Bs = True, mode_En = True, mode_Bn = True),
        MeasureFullType('P1', 'p1', 'Share of symbols present in the first annotation', 'float', mode_Bs = True, mode_Eq = True),
        MeasureFullType('P2', 'p2', 'Share of symbols present in the second annotation', 'float', mode_Bs = True, mode_Eq = True),
        MeasureFullType('E1', 'p1', 'Share of symbols enriched in the first annotation', 'float', mode_En = True, mode_Eq = True),
        MeasureFullType('E2', 'p2', 'Share of symbols enriched in the second annotation', 'float', mode_En = True, mode_Eq = True),
        MeasureFullType('TP', 'pp', 'Share of true positive symbols', 'float', mode_Bs = True, mode_En = True, mode_Bn = True),
        MeasureFullType('TP_b', 'pp1', 'Ratio of true positive symbols gross in the benchmark to the overall symbol count', 'float', mode_Bg = True, mode_Bn = True),
        MeasureFullType('TP_p', 'pp2', 'Ratio of true positive symbols gross in the prediction to the overall symbol count', 'float', mode_Bg = True, mode_Bn = True),
        MeasureFullType('PP', 'pp', 'Share of symbols present in both annotations', 'float', mode_Bs = True, mode_Eq = True),
        MeasureFullType('P1P2', 'pp1', 'Ratio of symbols gross present in the first annotation that are also present in the second to the overall symbol count', 'float', mode_Bg = True, mode_Eq = True),
        MeasureFullType('P2P1', 'pp2', 'Ratio of symbols gross present in the second annotation that are also present in the first to the overall symbol count', 'float', mode_Bg = True, mode_Eq = True),
        MeasureFullType('FP', 'ap', 'Share of false positive symbols', 'float', mode_Bs = True, mode_En = True, mode_Bn = True),
        MeasureFullType('FP', 'ap', 'Ratio of false positive symbols gross to the overall symbol count', 'float', mode_Bg = True, mode_Bn = True),
        MeasureFullType('AP', 'ap', 'Share of symbols absent in the first annotation but present in the second', 'float', mode_Bs = True, mode_Eq = True),
        MeasureFullType('AP', 'ap', 'Ratio of symbols gross absent in the first annotation but present in the second to the overall symbol count', 'float', mode_Bg = True, mode_Eq = True),
        MeasureFullType('FN', 'pa', 'Share of false negative symbols', 'float', mode_Bs = True, mode_En = True, mode_Bn = True),
        MeasureFullType('FN', 'pa', 'Ratio of false negative symbols gross to the overall symbol count', 'float', mode_Bg = True, mode_Bn = True),
        MeasureFullType('PA', 'pa', 'Share of symbols present in the first annotation but absent in the second', 'float', mode_Bs = True, mode_Eq = True),
        MeasureFullType('PA', 'pa', 'Ratio of symbols gross present in the first annotation but absent in the second to the overall symbol count', 'float', mode_Bg = True, mode_Eq = True),
        MeasureFullType('TN', 'aa', 'Share of true negative symbols', 'float', mode_Bs = True, mode_Bg = True, mode_En = True, mode_Bn = True),
        MeasureFullType('AA', 'aa', 'Share of symbols absent in both annotations', 'float', mode_Bs = True, mode_Bg = True, mode_Eq = True),
        MeasureFullType('EE', 'pp', 'Share of symbols enriched in both annotations', 'float', mode_En = True, mode_Eq = True),
        MeasureFullType('XE1', 'pa', 'Share of symbols enriched exclusively in the first annotation', 'float', mode_En = True, mode_Eq = True),
        MeasureFullType('XE2', 'ap', 'Share of symbols enriched exclusively in the second annotation', 'float', mode_En = True, mode_Eq = True),
        ...
        MeasureFullType('SiteN1', 'site_n1', 'Number of sites in the first annotation', 'int', mode_Bs = True, mode_Bg = True, mode_Eq = True),
        MeasureFullType('SiteN2', 'site_n2', 'Number of sites in the second annotation', 'int', mode_Bs = True, mode_Bg = True, mode_Eq = True),
        MeasureFullType('SiteNB', 'site_n1', 'Number of sites in the benchmark annotation', 'int', mode_Bs = True, mode_Bg = True, mode_Bn = True),
        MeasureFullType('SiteNP', 'site_n2', 'Number of sites in the prediction annotation', 'int', mode_Bs = True, mode_Bg = True, mode_Bn = True),
        MeasureFullType('SiteL1', 'site_len1', 'Total length of sites in the first annotation', 'int', mode_Bs = True, mode_Bg = True, mode_Eq = True),
        MeasureFullType('SiteL2', 'site_len2', 'Total length of sites in the second annotation', 'int', mode_Bs = True, mode_Bg = True, mode_Eq = True),
        MeasureFullType('SiteLB', 'site_len1', 'Total length of sites in the benchmark annotation', 'int', mode_Bs = True, mode_Bg = True, mode_Bn = True),
        MeasureFullType('SiteLP', 'site_len2', 'Total length of sites in the prediction annotation', 'int', mode_Bs = True, mode_Bg = True, mode_Bn = True),
    ...
    def __init__(self, enrichment_count, benchmark, gross):
        ...
        for measure in PerformanceMeasures.name_map_full:
            ...
            if (not gross) and (not (measure.mode_Bs or measure.mode_En)):
                continue
            self.name_map.append(MeasureType(measure.displayed_name, measure.var_name, measure.description, measure.type_))
        self._attr_list = []
