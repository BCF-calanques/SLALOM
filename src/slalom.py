...
input_controls.add_argument('-e', '--end_overflowpolicy', dest = 'end_overflow_policy', default = 'error', choices = ['error', 'trim', 'ignore'],
                            help = "Policy on overflowing site ends: raise {error}, {ignore} site or {trim} it (default: 'error')")
